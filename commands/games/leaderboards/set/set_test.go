...
import (
	...
	setcmd "github.com/PollyGlot/google-play-cli/commands/games/leaderboards/set"
)
...
func TestRun_happyPath_putsToResource(t *testing.T) {
	...
	_, err := setcmd.Run(rc, setcmd.Input{ID: "l9", Write: gamescmd.LeaderboardWrite{ScoreOrder: "SMALLER_IS_BETTER"}})
	if err != nil {
		t.Fatalf("Run: %v", err)
	}
