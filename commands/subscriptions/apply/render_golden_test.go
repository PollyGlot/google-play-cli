...
func fullPlan() reconcile.Plan {
	return reconcile.Plan{
		...
		BasePlanDeletes: []reconcile.Change{{ProductID: "basic/old-monthly"}},
		OfferCreates:    []reconcile.Change{{ProductID: "premium/monthly/intro"}},
		OfferPatches:    []reconcile.Change{{ProductID: "basic/yearly/winback", Fields: []string{"phases"}}},
		OfferDeletes:    []reconcile.Change{{ProductID: "basic/yearly/stale"}},
