...
func ListAchievements(ctx context.Context, hc *http.Client, appID string, maxResults int, pageToken string) (AchievementListResponse, json.RawMessage, error) {
	return doJSON[AchievementListResponse](ctx, hc, call(mAchList, opAchList, appID, map[string]string{"applicationId": appID}, listQuery(maxResults, pageToken), nil))
}
...
func GetAchievement(ctx context.Context, hc *http.Client, achievementID string) (AchievementConfiguration, json.RawMessage, error) {
	return doJSON[AchievementConfiguration](ctx, hc, call(mAchGet, opAchGet, achievementID, map[string]string{"achievementId": achievementID}, nil, nil))
}
...
func CreateAchievement(ctx context.Context, hc *http.Client, appID string, body []byte) (AchievementConfiguration, json.RawMessage, error) {
	return doJSON[AchievementConfiguration](ctx, hc, call(mAchInsert, opAchInsert, appID, map[string]string{"applicationId": appID}, nil, body))
}
...
func UpdateAchievement(ctx context.Context, hc *http.Client, achievementID string, body []byte) (AchievementConfiguration, json.RawMessage, error) {
	return doJSON[AchievementConfiguration](ctx, hc, call(mAchUpdate, opAchUpdate, achievementID, map[string]string{"achievementId": achievementID}, nil, body))
}
...
func DeleteAchievement(ctx context.Context, hc *http.Client, achievementID string) error {
	_, err := api.Do(ctx, hc, call(mAchDelete, opAchDelete, achievementID, map[string]string{"achievementId": achievementID}, nil, nil))
	return err
}
