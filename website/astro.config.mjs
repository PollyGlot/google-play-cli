  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        {
          label: 'Guides',
          // The 2.0 guide lives under docs/migration/ (the verb gate lets a
          // migration/ path name retired spellings), so it is listed by hand,
          // right after "Migrating to 1.0" (the last autogenerated guide).
          items: [
            { autogenerate: { directory: 'docs/guides' } },
            { label: 'Migrating to 2.0', slug: 'docs/migration/2.0' },
          ],
        },
        {
          label: 'AI agents',
