...
Réconcilier le [Monetization catalog](../CONTEXT.md) Play avec le catalogue RevenueCat (products / entitlements / offerings / packages) — miroir Android du skill iOS `asc-revenuecat-catalog-sync`.
