...
| post-v1 | [#51](https://github.com/PollyGlot/google-play-cli/issues/51) | monetization | Subscriptions v2 + IAP one-shot & one-time products v2 + sync RevenueCat | low | **Post-v1** (confirmé) — énorme, 3 niveaux imbriqués ; scope **étendu** le 2026-07-08 : [#293](https://github.com/PollyGlot/google-play-cli/issues/293) (`onetimeproducts` + `convertRegionPrices`) fusionné, legacy-vs-v2 tranché au grilling |
