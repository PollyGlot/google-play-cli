...
- Design authority: `docs/DESIGN.md` (auth precedence, exit codes, output, edit lifecycle); scope authority: `docs/BACKLOG.md` + `docs/COVERAGE.md` (generated by `make coverage-update` from `internal/apiregistry`, never hand-edited); surprising decisions: `docs/adr/`.
