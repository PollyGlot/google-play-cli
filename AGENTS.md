...
New surfaces earn their place through `docs/BACKLOG.md` first: surface the scope decision, then apply the matching `docs/DESIGN.md` section, write the RoundTripper-mocked test, and keep `--help` and docs in `CONTEXT.md` vocabulary.
